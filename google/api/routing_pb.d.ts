 ...
 */
export declare const file_google_api_routing: GenFile;
 ...
 */
export declare type RoutingRule = Message<"google.api.RoutingRule"> & {
  /**
 ...
 */
export declare type RoutingParameter = Message<"google.api.RoutingParameter"> & {
  /**
 ...
 */
export declare const RoutingParameterSchema: GenMessage<RoutingParameter>;
