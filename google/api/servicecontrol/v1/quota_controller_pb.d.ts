 ...
 */
export declare const file_google_api_servicecontrol_v1_quota_controller: GenFile;
 ...
 */
export declare type AllocateQuotaRequest = Message<"google.api.servicecontrol.v1.AllocateQuotaRequest"> & {
  /**
   ...
   */
  allocateOperation?: QuotaOperation | undefined;
 ...
 */
export declare const AllocateQuotaRequestSchema: GenMessage<AllocateQuotaRequest>;
 ...
 */
export declare type QuotaOperation = Message<"google.api.servicecontrol.v1.QuotaOperation"> & {
  /**
 ...
 */
export declare const QuotaOperationSchema: GenMessage<QuotaOperation>;
 ...
 */
export declare const QuotaOperation_QuotaModeSchema: GenEnum<QuotaOperation_QuotaMode>;
 ...
 */
export declare type AllocateQuotaResponse = Message<"google.api.servicecontrol.v1.AllocateQuotaResponse"> & {
  /**
 ...
 */
export declare const AllocateQuotaResponseSchema: GenMessage<AllocateQuotaResponse>;
 ...
 */
export declare type QuotaError = Message<"google.api.servicecontrol.v1.QuotaError"> & {
  /**
   * Error code.
   *
 ...
 */
export declare const QuotaErrorSchema: GenMessage<QuotaError>;
 ...
 */
export declare const QuotaError_CodeSchema: GenEnum<QuotaError_Code>;
 ...
 */
export declare const QuotaController: GenService<{
  /**
