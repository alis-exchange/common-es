 ...
 */
export declare const file_google_api_servicecontrol_v1_http_request: GenFile;
 ...
 */
export declare type HttpRequest = Message<"google.api.servicecontrol.v1.HttpRequest"> & {
  /**
