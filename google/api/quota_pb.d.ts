 ...
 */
export declare const file_google_api_quota: GenFile;
 ...
 */
export declare type Quota = Message<"google.api.Quota"> & {
  /**
 ...
 */
export declare type MetricRule = Message<"google.api.MetricRule"> & {
  /**
 ...
 */
export declare const MetricRuleSchema: GenMessage<MetricRule>;
 ...
 */
export declare type QuotaLimit = Message<"google.api.QuotaLimit"> & {
  /**
