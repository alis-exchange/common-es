 ...
 */
export declare const file_google_api_logging: GenFile;
 ...
 */
export declare type Logging = Message<"google.api.Logging"> & {
  /**
 ...
 */
export declare const LoggingSchema: GenMessage<Logging>;
 ...
 */
export declare type Logging_LoggingDestination = Message<"google.api.Logging.LoggingDestination"> & {
  /**
