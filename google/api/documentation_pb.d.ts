 ...
 */
export declare const file_google_api_documentation: GenFile;
 ...
 */
export declare type Documentation = Message<"google.api.Documentation"> & {
  /**
 ...
 */
export declare const DocumentationSchema: GenMessage<Documentation>;
 ...
 */
export declare type DocumentationRule = Message<"google.api.DocumentationRule"> & {
  /**
 ...
 */
export declare const DocumentationRuleSchema: GenMessage<DocumentationRule>;
 ...
 */
export declare type Page = Message<"google.api.Page"> & {
  /**
