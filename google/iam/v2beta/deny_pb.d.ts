 ...
 */
export declare const file_google_iam_v2beta_deny: GenFile;

/**
 * A deny rule in an IAM deny policy.
 *
 * @generated from message google.iam.v2beta.DenyRule
 */
export declare type DenyRule = Message<"google.iam.v2beta.DenyRule"> & {
  /**
   ...
   *
   * @generated from field: repeated string denied_principals = 1;
   */
   ...
   * the internet.
   *
   * @generated from field: repeated string exception_principals = 2;
   */
   ...
   *
   * @generated from field: repeated string denied_permissions = 3;
   */
   ...
   * `denied_permissions`.
   *
   * @generated from field: repeated string exception_permissions = 4;
   */
   ...
   *
   * @generated from field: google.type.Expr denial_condition = 5;
   */
