 ...
 */
export declare const file_google_iam_v1_policy: GenFile;
 ...
 */
export declare type Policy = Message<"google.iam.v1.Policy"> & {
  /**
 ...
 */
export declare type Binding = Message<"google.iam.v1.Binding"> & {
  /**
 ...
 */
export declare type AuditConfig = Message<"google.iam.v1.AuditConfig"> & {
  /**
 ...
 */
export declare const AuditConfigSchema: GenMessage<AuditConfig>;
 ...
 */
export declare type AuditLogConfig = Message<"google.iam.v1.AuditLogConfig"> & {
  /**
 ...
 */
export declare const AuditLogConfigSchema: GenMessage<AuditLogConfig>;
 ...
 */
export declare const AuditLogConfig_LogTypeSchema: GenEnum<AuditLogConfig_LogType>;
 ...
 */
export declare type PolicyDelta = Message<"google.iam.v1.PolicyDelta"> & {
  /**
 ...
 */
export declare type BindingDelta = Message<"google.iam.v1.BindingDelta"> & {
  /**
 ...
 */
export declare type AuditConfigDelta = Message<"google.iam.v1.AuditConfigDelta"> & {
  /**
 ...
 */
export declare const AuditConfigDeltaSchema: GenMessage<AuditConfigDelta>;
