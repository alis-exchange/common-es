 ...
 */
export declare const file_google_iam_v2_deny: GenFile;

/**
 * A deny rule in an IAM deny policy.
 *
 * @generated from message google.iam.v2.DenyRule
 */
export declare type DenyRule = Message<"google.iam.v2.DenyRule"> & {
  /**
